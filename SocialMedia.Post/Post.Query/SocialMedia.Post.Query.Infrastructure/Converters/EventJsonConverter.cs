...
namespace SocialMedia.Post.Query.Infrastructure.Converters;
...
public class EventJsonConverter : JsonConverter<BaseEvent>
{
    ...
    public override BaseEvent Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        if(!doc.RootElement.TryGetProperty(nameof(BaseEvent.Type), out var type))
        {
            throw new JsonException($"Could not detect the {nameof(BaseEvent.Type)} discriminator property");
        }
